    ...
    <>
      ...
      >
        <div className="flex items-center justify-between gap-2.5 px-5 py-5">
          ...
          <button onClick={onClose} className="rounded-md p-1.5 text-slate-400 hover:bg-slate-800 hover:text-white lg:hidden">
            <X className="h-5 w-5" />
          </button>
        </div>
        ...
        <div className="px-3 pb-2">
          <Link
            href="/pos"
            onClick={onClose}
            title={collapsed ? "Open POS app" : undefined}
          ...
          >
            ...
            <span className={collapsed ? "lg:hidden" : ""}>Open POS app</span>
          </Link>
        </div>

        <button
          onClick={onToggleCollapse}
          className="hidden items-center justify-center gap-2 border-t border-slate-800 py-2.5 text-xs font-medium text-slate-400 hover:bg-slate-800 hover:text-white lg:flex"
        >
        ...
        <div className="border-t border-slate-800 px-4 py-4">
          <div className={`flex items-center gap-3 ${collapsed ? "lg:justify-center" : ""}`}>
            <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-brand-500 text-xs font-semibold text-white">ID</div>
            {!collapsed && (
            ...
            <button onClick={() => { logout(); router.replace("/login"); }} title="Sign out" className={`rounded-md p-1.5 text-slate-400 hover:bg-slate-800 hover:text-white ${collapsed ? "lg:hidden" : ""}`}>
