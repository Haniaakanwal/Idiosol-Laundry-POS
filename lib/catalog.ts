...
export const FEATURES: FeatureModule[] = [
  ...
  },
  {
    ...
    description: "Corporate / contract accounts with billing terms and running balances.",
    category: "Core",
    fmTables: ["Business"],
  },
  {
  ...
  },
  {
    key: "vat",
    name: "VAT Returns",
    description: "Tax period returns, submissions and audit history.",
    category: "Finance",
    fmTables: ["VAT Returns"],
  },
  {
    key: "reports",
